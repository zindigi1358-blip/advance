...
# ── DISCORD ALERTS — up to 5+ webhooks, broadcast to ALL of them ───────────
# Khali ("") wale automatically skip ho jaate hain. Jitni chahiye utni daalo.
DISCORD_WEBHOOKS = [
    os.environ.get("DISCORD_WEBHOOK_1", ""),   # ← 👈 webhook URL #1 (e.g. SOC channel)
    os.environ.get("DISCORD_WEBHOOK_2", ""),   # ← 👈 webhook URL #2 (e.g. management channel)
    os.environ.get("DISCORD_WEBHOOK_3", ""),   # ← 👈 webhook URL #3
    os.environ.get("DISCORD_WEBHOOK_4", ""),   # ← 👈 webhook URL #4
    os.environ.get("DISCORD_WEBHOOK_5", ""),   # ← 👈 webhook URL #5
]
